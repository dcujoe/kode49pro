                        ...
                        <div className="swiper-wrapper">
                            <div className="testimonial__card swiper-slide">
                                ...
                                <div className="testimonial__perfil">
                                    <img src={homeimage} alt="" className="testimonial__perfil-img"/>
                            ...
                            <div className="testimonial__card swiper-slide">
                                ...
                                <p className="testimonial__description">
                                   Best pullovers in Germany for ladies. Can be used at all times of the year.
                                   We have different collections you can choose from Summer, Winter, Sprint and Autumn.
                                   Get your orders done now.
                                </p>
                                <h3 className="testimonial__date">March 27. 2021</h3>
